...
The [ReservationDomain](https://github.com/thma/PolysemyCleanArchitecture/tree/master/src/Domain/ReservationDomain.hs) module implements the business logic for
...
![The Domain layer](/img/domain.png)
...
as you can see from the [DomainSpec](https://github.com/thma/PolysemyCleanArchitecture/tree/master/test/DomainSpec.hs) code.
...
The module [ReservationUseCase](https://github.com/thma/PolysemyCleanArchitecture/tree/master/src/UseCases/ReservationUseCase.hs) specifies the available use cases for the reservation system.
...
also defined in the use case layer ([KVS.hs](https://github.com/thma/PolysemyCleanArchitecture/tree/master/src/UseCases/KVS.hs)):
...
![Use Cases layer](/img/use-cases.png)
...
As an example, in [UseCasePureSpec](https://github.com/thma/PolysemyCleanArchitecture/tree/master/test/UseCasePureSpec.hs) I'm providing pure interpretations
for all effects.
...
implementation from the [KVSInMemory](https://github.com/thma/PolysemyCleanArchitecture/tree/master/src/InterfaceAdapters/KVSInMemory.hs) module.
...
in [KVSSqllite.hs](https://github.com/thma/PolysemyCleanArchitecture/tree/master/src/InterfaceAdapters/KVSSqlite.hs).
...
[explore on your own](https://github.com/thma/PolysemyCleanArchitecture/tree/master/src/InterfaceAdapters/KVSFileServer.hs)).

![Interface Adapters layer](/img/interface-adapters.png)

### Testing the KVS implementations

We'll have a closer look at the [test of the SQLite implementation](https://github.com/thma/PolysemyCleanArchitecture/tree/master/test/InterfaceAdaptersKVSSQLiteSpec.hs)
of the `KVS` effect.
...
[ApplicationAssembly module](https://github.com/thma/PolysemyCleanArchitecture/tree/master/src/ExternalInterfaces/ApplicationAssembly.hs) will look quite familiar,
...
![External Interfaces layer](/img/clean-architecture.png)
...
[SwaggerUI](https://github.com/thma/PolysemyCleanArchitecture/tree/master/app/SwaggerUI.hs) module.
